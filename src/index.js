...
var createChannels_1 = require("./createChannels");
__exportStar(require("colors"), exports);
// Defina __rootname usando __dirname
var __rootname = __dirname;
// Carregar a fonte 'Strong Young'
canvas_1.GlobalFonts.registerFromPath((0, path_1.join)(__rootname, "../assets/fonts/alienware_font_by_naeki_design_d39j8zu.ttf"), 'AlienCaret');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, createChannels_1.createChannels)(client)];
            case 1:
                _a.sent();
